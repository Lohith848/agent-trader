...
class ModelValidationTests(unittest.TestCase):
    ...
    def test_unknown_model_emits_warning_for_strict_provider(self):
        client = DummyLLMClient("google", "not-a-real-google-model")
        ...
        self.assertIn("not-a-real-google-model", str(caught[0].message))
        self.assertIn("google", str(caught[0].message))
